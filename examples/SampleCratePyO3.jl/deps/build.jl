...
#
#   1. `cargo build --release` of ../../sample_crate_pyo3 *without* the
#      `python` feature — the Julia build never links Python;
...
# ../../sample_crate_pyo3/README.md); this package never touches it.

using RustCall

const CRATE_DIR = normpath(joinpath(@__DIR__, "..", "..", "sample_crate_pyo3"))
