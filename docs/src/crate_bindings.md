...
(`# Bindings format: 2`). A file generated by an older RustCall keeps working,
but does not get the unload, panic-containment or lifetime guarantees described
above — regenerate it after upgrading RustCall.
