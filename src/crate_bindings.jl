...
function _generate_result_function_wrapper(func::RustFunctionSignature, arg_syms::Vector{Symbol},
    ...
    ok_slot_type = ffi_return_slot_symbol_or_throw(func.ok_type, "", ctx)
    err_slot_type = ffi_return_slot_symbol_or_throw(func.err_type, "", ctx)
...
function _generate_option_function_wrapper(func::RustFunctionSignature, arg_syms::Vector{Symbol},
    ...
    inner_slot_type = ffi_return_slot_symbol_or_throw(func.inner_type, "", _ffi_context(func))
...
function _emit_result_function_code(func::RustFunctionSignature, arg_syms::String, converted_args_str::String;
    ...
    ok_slot_str = string(ffi_return_slot_symbol_or_throw(func.ok_type, "", ctx; strict = strict))
    err_slot_str = string(ffi_return_slot_symbol_or_throw(func.err_type, "", ctx; strict = strict))
    sym = func.symbol
...
function _emit_option_function_code(func::RustFunctionSignature, arg_syms::String, converted_args_str::String;
    ...
    inner_type_str = string(ffi_return_symbol_or_throw(func.inner_type, "",
                                                       _ffi_context(func); strict = strict))
    inner_slot_str = string(ffi_return_slot_symbol_or_throw(func.inner_type, "",
                                                            _ffi_context(func); strict = strict))
    sym = func.symbol
