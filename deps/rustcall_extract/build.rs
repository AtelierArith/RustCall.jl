...
//! below is of exactly what decides this binary's output — its own sources and
//! `rustcall_core`'s — with each crate's `[package] version` left out, and is
//! printed by `rustcall-extract source-digest`.
